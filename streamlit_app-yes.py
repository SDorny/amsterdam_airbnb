...
st.markdown("The dataset includes Airbnb data from Amsterdam, the capital of the Netherlands. The data provided consisted of the Airbnb Listing ID, Price, Latitude, and Longitude columns. Modifications were made to the existing columns in addition to creating two new columns for further analysis. These are Meters from chosen location and Location.")
st.markdown("For my project, I made a few personal modifications. I converted the price from USD to Argentine Pesos, researched a location I wanted to visit (Van Gogh Museum), and added a slider for price and Meters from location. ")
st.markdown("Wtih all this information gathered, I can quickly filter Airbnb listings that are too expsensive and too far away, allowing me to spend my time focusing on the details of places I know are within my ideal parameters.")
...
meters_from = st.sidebar.slider('Meters from Location', min_value=100, max_value=16000, step=500, value=16000)
